...
//     //     {5,6,7,8},
//     //     {9,10,11,12}
//     // };                            atleast column size we have to give
...
//     // for(int i=0; i<row; i++) {
//     //    for(int j=0; j<col; j++) {
//     //     cout<<"Enter the input for row index " <<i << " " <<"Enter the input for col index 2" <<j <<" " <<" : ";
//     //     cin>>arr2[i][j];
//     //    }
//     //    cout<<endl;
//     // }
...
//     vector<vector<int>>arr3(5, vector<int>(10,0));
//     //row size = arr.size()
...
//     int col = 4;    
//     int target = 110;
//     int tar = findTarget(arr, row, col,110);
//     cout << tar << endl;
// }